...
export default function ValueTurnaroundPage() {
  ...
  function runway(s: Stock): string {
    if (s.financialApplicability?.requiresSectorModel) return "Not applicable";
            ...
            <tbody className="divide-y divide-gray-800">
              {stocks.map((s) => (
                <tr key={s.id} className="hover:bg-gray-900/40 transition-colors">
                  <td className="px-3 py-3 text-gray-500 text-xs whitespace-nowrap">#{s.turnaroundRank}<RankChangeBadge delta={s.rankChange} /></td>
