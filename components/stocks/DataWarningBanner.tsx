    ...
    >
      ...
      <div>
        ...
        <p className="text-xs opacity-80 mt-0.5">
          Some required inputs are missing, stale, or lack a verified reporting period. Partial scores use
          only available inputs. Data collection runs separately from market scans; coverage varies by source.
        </p>
      </div>
    </div>
  );
