...
export function parseBQStatements(ticker:string,responses:Partial<Record<string,BQResponse>>,now=new Date()):FinancialBundle|null {
 ...
 return {revenueGrowthYoY,version:'FINANCIAL_DATA_V1',source:'BUSINESS_QUANT',cik:String(meta.cik).padStart(10,'0'),periodType:'QUARTER',periodEnd:end,currency:meta.currency!,values,evidence,missingReasons};
}
