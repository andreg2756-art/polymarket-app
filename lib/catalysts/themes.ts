...
export const MACRO_THEMES: MacroTheme[] = [
  {
    ...
    conditionLabel: "Fed cuts rates by the September 2026 meeting",
  ...
  },
  {
    ...
    conditionLabel: "August jobs report prints weak (loses jobs or adds very few)",
    primaryMarketConditionId: "0xb72571fb88a793a38be9a5104e3adb19a5ff886e339e1e5cb14e98fc2ae44e59",
    primaryMarketOutcomeIndex: 0, // "Will the US lose more than 50k jobs in August?" — Yes = weak print
    ...
    exposures: [
      { ticker: "RHI", name: "Robert Half", direction: "negative", exposureStrength: "high", confidence: "high",
        condition: "if the August jobs report prints weak",
  ...
  },
  {
    ...
    conditionLabel: "OpenAI's IPO is confirmed by year-end 2026",
    ...
    exposures: [
      { ticker: "MSFT", name: "Microsoft", direction: "positive", exposureStrength: "high", confidence: "high",
        condition: "if OpenAI's IPO is confirmed",
